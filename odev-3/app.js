...
categories.forEach((category) => {
	...
	btn.addEventListener("click",function(event){
		...
		{
			filtre = menu.filter(item => item.category == event.target.innerHTML);
		}	
		
		
		let contentDom = document.querySelector(".section-center.row");
		
		document.querySelectorAll(".menu-items").forEach((menuItem) => {menuItem.remove()});
